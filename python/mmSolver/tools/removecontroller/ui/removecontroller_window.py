...
#
"""
Window for the Remove Controller tool.
...
import mmSolver.tools.removecontroller.tool as tool
import mmSolver.tools.removecontroller.ui.removecontroller_layout as rm_ctrl_layout


LOG = mmSolver.logger.get_logger()
baseModule, BaseWindow = uiutils.getBaseWindow()
WINDOW_TITLE = 'Remove Controller'
...
class RemoveController1Window(BaseWindow):
    name = 'RemoveController1Window'

    def __init__(self, parent=None, name=None):
        super(RemoveController1Window, self).__init__(parent, name=name)
        self.setupUi(self)
        self.addSubForm(rm_ctrl_layout.RemoveController1Layout)
...
def main(show=True, auto_raise=True, delete=False):
    ...
    """
    win = RemoveController1Window.open_window(
        show=show,
